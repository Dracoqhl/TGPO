...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/Data/haolong/model_deploy/models_cache/Qwen2.5-0.5B-Instruct \
    ...
    critic.model.path=/Data/haolong/model_deploy/models_cache/Qwen2.5-0.5B-Instruct \
